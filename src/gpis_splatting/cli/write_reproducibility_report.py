...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", default=None, help="Optional JSON preset or config used for the run.")
    parser.add_argument("--run-command", action="append", default=[], help="Command line to record. May be passed multiple times.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    report_path = write_reproducibility_report(
        ...
        command_lines=args.run_command,
        commit=args.commit,
